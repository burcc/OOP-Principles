...
{
    public float zRangeMax = 80.0f;

    private float zRangeMin = 50f;
    

    private float xRangeMax = 165.0f;
    private float xRangeMin = 154.0f;

    public GameObject[] enemyArray;
    // Start is called before the first frame update
    void Start()
    {
        InvokeRepeating("GenerateSpawnPosition", 2, 10.0f);
    }
